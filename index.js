const contentLetterSrart_actived = "Chúc mày sinh nhật vui vẻ, tuổi mới xinh lại thêm xinh, duyên lại càng thêm duyên và yêu đời nhé!" //Lời mở đầu cho bức thư
const mainContentLetter = "Happy birthday bạn yêu, biết bạn không thích gì ngoài tiền nên nhân dịp sinh nhật, chúc bạn tôi công thành danh toại, tiền vào như nước để còn thường xuyên dắt mình đi ăn ké. " 

let imgStart = document.querySelector(".myAI"); 
imgStart.src = "./img/cute-young-boy-kid-wearing-vest-and-hat-free-png.png";

let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/cute-young-boy-kid-wearing-vest-and-hat-free-png.png"; 
